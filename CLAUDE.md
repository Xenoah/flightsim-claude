...
交代の都度の申し送りは [docs/handoff-notes/](docs/handoff-notes/) にあります（最新: [2026-08-30](docs/handoff-notes/2026-08-30-to-codex.md)）。
...
cargo run -p flightsim-tilegen --bin flightsim-airportgen -- --help  # OSM 滑走路 DB の焼き込み
