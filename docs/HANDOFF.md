...
更新: 2026-08-03（TASK-1 接地反力・着陸装置完了）
...
まだ満たしていない。接地反力は完了した。残りはタイル生成 CLI と、その実地形を FDM へ
渡すヘッドレス統合ランナー。
...
### TASK-2: タイル生成 CLI（新クレート `flightsim-tilegen`）— 次に着手
...
TASK-1 は `simulation` 担当で完了。次の TASK-2 は `world` 担当。その定義を読むこと。
